pub fn run(
    ...
    println!("     experimental=true     Include experimental diagnostics");
    println!("     telemetry=true        Include telemetry_v1 snapshot");
    println!("     (experimental and telemetry are independent opt-ins)");
    println!(
        "     sample_bytes=N        Raw bytes/source for diagnostics (64-4096, default: 1024)"
    );
    if !allow_raw {
    ...
    println!("     curl {base}/sources?experimental=true&sample_bytes=1024");
