...
//!
//! `quantum_fraction ≈ 0.30` — PLL thermal noise (Johnson-Nyquist in VCO
//! transistors) is real but kernel lock contention and IOKit serialization
//! dominate the timing variance. Not pure quantum, but the PLL noise component
//! is genuine thermal/quantum.
