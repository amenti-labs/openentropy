...
unsafe extern "C" {
    ...
    fn proc_pid_rusage(pid: i32, flavor: i32, buffer: *mut *mut core::ffi::c_void) -> i32;
...
#[repr(C, align(8))]
struct RusageInfoV4 {
    _pad: [u8; 256], // large enough for rusage_info_v4
}
...
impl EntropySource for ProcInfoTimingSource {
    ...
    fn collect(&self, n_samples: usize) -> Vec<u8> {
        ...
        let mut ru_info = RusageInfoV4 { _pad: [0u8; 256] };
