...
impl EntropySource for PreemptionBoundarySource {
    ...
    fn collect(&self, n_samples: usize) -> Vec<u8> {
        ...
        // Extract entropy from the distribution of jump sizes.
        // Large jumps (>100 ticks) are IRQ events with high entropy.
        // Small jumps (1–5 ticks) are timer resolution artifacts with lower entropy.
        // Weight them by mixing: each sample draws from the full distribution.
        extract_timing_entropy(&preemption_times, n_samples)
    }
}
