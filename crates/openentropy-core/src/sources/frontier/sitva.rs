...
static SITVA_INFO: SourceInfo = SourceInfo {
    ...
    entropy_rate_estimate: 9000.0, // CV=189% × AES sample rate
    composite: false,
};
...
mod tests {
    ...
    fn info() {
        ...
        // Entropy rate should exceed aes_exec_timing (6000) since CV is 2.85×
        assert!(src.info().entropy_rate_estimate > 8000.0);
    }
