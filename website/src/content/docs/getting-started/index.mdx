...
- [Choose Your Path](/openentropy/getting-started/choose-your-path/) — guided route by role
- [Quickstart](/openentropy/getting-started/quickstart/) — cross-SDK examples
