...
## What This Is
OpenEntropy harvests hardware entropy from 37 unconventional sources on consumer devices. Rust workspace with Python bindings.
...
- **205 tests, 0 clippy warnings.** Keep it that way.
...
- **Frontier** (7): amx_timing, thread_lifecycle, mach_ipc, tlb_shootdown, pipe_buffer, kqueue_events, interleaved_frontier
