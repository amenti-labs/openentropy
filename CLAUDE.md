...
## What This Is
OpenEntropy harvests hardware entropy from 38 unconventional sources on consumer devices. Rust workspace with Python bindings.
...
- **251 tests, 0 clippy warnings.** Keep it that way.
...
- **Frontier** (8): amx_timing, thread_lifecycle, mach_ipc, tlb_shootdown, pipe_buffer, kqueue_events, dvfs_race, cas_contention
...
## Platform
Primary: macOS Apple Silicon (M1-M4). 34/38 sources available on Mac Mini, 38/38 on MacBook.
